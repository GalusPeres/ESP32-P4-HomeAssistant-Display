...
const html = readRepoFile('src', 'web', 'web_admin_html.cpp');
const css = readRepoFile('src', 'web', 'assets', 'admin.css');
const i18nHeader = readRepoFile('src', 'core', 'i18n.h');
const scripts = readRepoFile('src', 'web', 'web_admin_scripts.cpp');
