// The Strings and LocaleProfile tables in src/core/i18n.cpp use positional
...
const header = readRepoFile('src', 'core', 'i18n.h');
const source = readRepoFile('src', 'core', 'i18n.cpp');
