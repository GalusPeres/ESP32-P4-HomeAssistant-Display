...
<img src="docs/images/b4-home.png" alt="Home dashboard" width="33%"> <img src="docs/images/b4-folder-lights.png" alt="Folder view" width="33%"> <img src="docs/images/b4-settings.png" alt="Settings view" width="33%">

### Popups

Sensor history, weather details, and light control popups:

<img src="docs/images/b4-sensor-popup-kitchen.png" alt="Kitchen sensor popup" width="33%"> <img src="docs/images/b4-sensor-popup-water.png" alt="Water sensor popup" width="33%"> <img src="docs/images/b4-sensor-popup-battery.png" alt="Battery sensor popup" width="33%"> <img src="docs/images/b4-weather-popup.png" alt="Weather popup" width="33%"> <img src="docs/images/b4-light-popup-desk.png" alt="Light control popup" width="33%">
