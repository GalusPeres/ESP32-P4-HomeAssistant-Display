 ...
 * Size: 48 px
 * Bpp: 4
 * Opts: --bpp 4 --no-compress --format lvgl --size 48 --font C:/Users/Sebastian/AppData/Local/Microsoft/Windows/Fonts/Montserrat-Medium.ttf --range 32-127 --symbols °²³µÄÖÜäöüß€ -o src/fonts/ui_font_48.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 36089, .adv_w = 330, .box_w = 18, .box_h = 19, .ofs_x = 1, .ofs_y = 16},
    {.bitmap_index = 36260, .adv_w = 330, .box_w = 18, .box_h = 19, .ofs_x = 1, .ofs_y = 16},
    {.bitmap_index = 36431, .adv_w = 524, .box_w = 25, .box_h = 35, .ofs_x = 4, .ofs_y = -9},
    {.bitmap_index = 36869, .adv_w = 562, .box_w = 37, .box_h = 43, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 37665, .adv_w = 645, .box_w = 37, .box_h = 43, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 38461, .adv_w = 607, .box_w = 30, .box_h = 43, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 39106, .adv_w = 519, .box_w = 27, .box_h = 36, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 39592, .adv_w = 459, .box_w = 23, .box_h = 36, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 40006, .adv_w = 488, .box_w = 27, .box_h = 36, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 40492, .adv_w = 520, .box_w = 25, .box_h = 36, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 40942, .adv_w = 612, .box_w = 36, .box_h = 34, .ofs_x = 1, .ofs_y = 0}
};
