 ...
 * Size: 28 px
 * Bpp: 4
 * Opts: --bpp 4 --no-compress --format lvgl --size 28 --font C:/Users/Sebastian/AppData/Local/Microsoft/Windows/Fonts/Montserrat-Medium.ttf --range 32-127 --symbols °²³µÄÖÜäöüß€ -o ui_font_28.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 13056, .adv_w = 328, .box_w = 22, .box_h = 25, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 13331, .adv_w = 376, .box_w = 22, .box_h = 25, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 13606, .adv_w = 354, .box_w = 18, .box_h = 25, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 13831, .adv_w = 303, .box_w = 16, .box_h = 21, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 13999, .adv_w = 268, .box_w = 14, .box_h = 21, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 14146, .adv_w = 284, .box_w = 16, .box_h = 21, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 14314, .adv_w = 303, .box_w = 15, .box_h = 21, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 14472, .adv_w = 357, .box_w = 22, .box_h = 20, .ofs_x = 0, .ofs_y = 0}
};
