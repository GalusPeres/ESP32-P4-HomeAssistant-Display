 ...
 * Size: 20 px
 * Bpp: 4
 * Opts: --bpp 4 --no-compress --format lvgl --size 20 --font C:/Users/Sebastian/AppData/Local/Microsoft/Windows/Fonts/Montserrat-Medium.ttf --range 32-127 --symbols °²³µÄÖÜäöüß€ -o ui_font_20.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 6740, .adv_w = 138, .box_w = 8, .box_h = 8, .ofs_x = 0, .ofs_y = 7},
    {.bitmap_index = 6772, .adv_w = 218, .box_w = 11, .box_h = 15, .ofs_x = 1, .ofs_y = -4},
    {.bitmap_index = 6855, .adv_w = 234, .box_w = 16, .box_h = 18, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 6999, .adv_w = 269, .box_w = 16, .box_h = 19, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 7151, .adv_w = 253, .box_w = 13, .box_h = 19, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7275, .adv_w = 216, .box_w = 12, .box_h = 15, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7365, .adv_w = 191, .box_w = 10, .box_h = 15, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7440, .adv_w = 203, .box_w = 12, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 7530, .adv_w = 217, .box_w = 11, .box_h = 15, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7613, .adv_w = 255, .box_w = 16, .box_h = 14, .ofs_x = 0, .ofs_y = 0}
};
