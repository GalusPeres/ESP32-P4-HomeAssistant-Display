 ...
 * Size: 40 px
 * Bpp: 4
 * Opts: --bpp 4 --no-compress --format lvgl --size 40 --font C:/Users/Sebastian/AppData/Local/Microsoft/Windows/Fonts/Montserrat-Medium.ttf --range 32-127 --symbols °²³µÄÖÜäöüß€ -o ui_font_40.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 26157, .adv_w = 275, .box_w = 15, .box_h = 17, .ofs_x = 1, .ofs_y = 13},
    {.bitmap_index = 26285, .adv_w = 275, .box_w = 15, .box_h = 17, .ofs_x = 1, .ofs_y = 13},
    {.bitmap_index = 26413, .adv_w = 436, .box_w = 21, .box_h = 30, .ofs_x = 3, .ofs_y = -8},
    {.bitmap_index = 26728, .adv_w = 468, .box_w = 31, .box_h = 36, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 27286, .adv_w = 538, .box_w = 31, .box_h = 37, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 27860, .adv_w = 506, .box_w = 25, .box_h = 37, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 28323, .adv_w = 433, .box_w = 23, .box_h = 31, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 28680, .adv_w = 383, .box_w = 19, .box_h = 31, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 28975, .adv_w = 406, .box_w = 23, .box_h = 31, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 29332, .adv_w = 433, .box_w = 21, .box_h = 31, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 29658, .adv_w = 510, .box_w = 30, .box_h = 29, .ofs_x = 1, .ofs_y = 0}
};
