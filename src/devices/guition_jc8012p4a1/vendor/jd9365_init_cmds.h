 ...
 *
 * Modified for HomeTiles: extracted the JC8012P4A1 command table and omitted
 * the optional 0x4A/0x35 write that is disabled in Espressif's source.
 * Source: guitionofficial/P4-series, esp_lcd_jd9365.c, blob
 * 80492fc86104e5349d5fec659bfbd1ea9562b700.
 */
...
static const jd9365_lcd_init_cmd_t guition_jc8012p4a1_init_cmds[] = {
    // Page select: user
...
static constexpr size_t guition_jc8012p4a1_init_cmds_count =
    sizeof(guition_jc8012p4a1_init_cmds) / sizeof(guition_jc8012p4a1_init_cmds[0]);
