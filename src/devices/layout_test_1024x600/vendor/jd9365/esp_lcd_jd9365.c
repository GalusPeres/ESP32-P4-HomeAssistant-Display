...
// NOTE: i2c_bus.h (esp-iot-solution) is NOT used in this fork; PMIC init
// at I2C addr 0x45 is performed by device_layout_test_1024x600.cpp.

#ifndef CONFIG_BSP_LCD_TYPE_800_1280_8_INCH_A
...
esp_err_t esp_lcd_new_panel_jd9365_layout_test(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config,
                                   esp_lcd_panel_handle_t *ret_panel)
{
    ...
    // PMIC init (I2C addr 0x45) is performed externally by the board driver
    // before esp_lcd_new_panel_jd9365_layout_test() is called. See
    // src/devices/layout_test_1024x600/device_layout_test_1024x600.cpp.
...
#endif  // DEVICE_LAYOUT_TEST_1024X600
