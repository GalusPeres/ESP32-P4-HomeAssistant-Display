...
// NOTE: Waveshare's ESP-IDF component uses esp-iot-solution i2c_bus here
// for the panel PMIC. That dependency is not available in Arduino builds, so
// the board driver performs the PMIC init before esp_lcd_new_panel_jd9365_layout_test_8().
...
esp_err_t esp_lcd_new_panel_jd9365_layout_test_8(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config,
                                   esp_lcd_panel_handle_t *ret_panel)
{
    ...
    // PMIC init is intentionally external in the Arduino port.
