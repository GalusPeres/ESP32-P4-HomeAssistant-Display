/*
 * Panel initialization sequences derived from Waveshare's
 * ESP32-P4-WIFI6-Touch-LCD-X BSP at commit
 * 6ec9ff5c8a96357f2fcac24b4fc311a3018cb878.
 *
 * SPDX-License-Identifier: Apache-2.0
 *
 * Modified for HomeTiles: the model branches were split into standalone
 * compile-time targets and the exported symbol names were changed.
 */
...
const jd9365_lcd_init_cmd_t kWaveshareJd9365Init10_1[] = {
...
const size_t kWaveshareJd9365Init10_1Count =
    sizeof(kWaveshareJd9365Init10_1) / sizeof(kWaveshareJd9365Init10_1[0]);
